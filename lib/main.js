...
(function (factory) {
    if (typeof exports == 'object')
        module.exports = factory(Buffer, require('stream'), require('util'));
    else if ((typeof define == 'function') && define.amd)
        define(['Node.js/buffer', 'Node.js/stream', 'Node.js/util'],
            function (buffer, stream, util) {
                return factory(buffer.Buffer, stream, util);
            });
}(function (Buffer, stream, util) {
