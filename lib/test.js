...
var assert = require('assert2'),
    ...
    fakeBufferedAmount = clientSocket.bufferedAmount,
...
// Redefine bufferedAmount so we can monkey with it in our tests.
Object.defineProperty(clientSocket, 'bufferedAmount', {
    get: function () {
        return fakeBufferedAmount;
    },

    set: function (value) {
        fakeBufferedAmount = value;
    }
});
